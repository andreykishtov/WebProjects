...
newApp2.controller('roboListCtrl', ['$scope', '$element', function(S, E) {
    this.remove = function(item) {
        var index = this.items.indexOf(item)
        this.items.splice(index, 1);
    };

    this.items = [{ "image": "https://robohash.org/nonrepellendusrecusandae.jpg?size=150x150&set=set1", "fname": "Fedora", "lname": "Mulcaster", "Phone": "46-(560)800-6649" },
