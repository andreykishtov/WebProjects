(function () { //d
    ...
    function component() {
        function componentController(jobsListService, $rootScope, $log, $state, localStorageService) {
            var vm = this;
        ...
        return {
            bindings: {},
            controller: ['jobsListService', '$rootScope', '$log', '$state', 'localStorageService', componentController],
            controllerAs: 'vm',
